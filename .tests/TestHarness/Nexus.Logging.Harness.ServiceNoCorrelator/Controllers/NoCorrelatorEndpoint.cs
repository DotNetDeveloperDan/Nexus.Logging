...
namespace Nexus.Logging.Harness.ServiceNoCorrelator.Controllers
{
    ...
    public class NoCorrelatorEndpoint : ControllerBase
    {
        ...
        public NoCorrelatorEndpoint(ILogger<NoCorrelatorEndpoint> logger, IHttpClientFactory httpClientFactory, ApplicationScopeOptions applicationScopeOptions)
        {
            _logger = logger;
        ...
        {
            _logger.Log(LogLevel.Info, $"Entering {nameof(NoCorrelatorEndpoint)} in {_applicationScopeOptions.ApplicationName}");
