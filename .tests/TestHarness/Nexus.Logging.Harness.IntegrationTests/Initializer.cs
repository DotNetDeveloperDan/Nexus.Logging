...
using Nexus.Logging.Harness.Service3;
...
public static class Initializer
{
    ...
    /// <returns></returns>
    public static HttpClient InitTestHarness(HttpMessageHandler secondServiceHandler,
        HttpMessageHandler noCorrelatorHandler)
    {
        ...
        var builder = new WebHostBuilder()
            ...
            .ConfigureTestServices(services =>
            {
                services.AddHttpClient("SecondService").ConfigurePrimaryHttpMessageHandler(_ => secondServiceHandler)
                    .AddCorrelationHandler();
                services.AddHttpClient("ServiceNoCorrelator")
                    .ConfigurePrimaryHttpMessageHandler(_ => noCorrelatorHandler);
            });
