...
namespace Nexus.Logging.Tests
{
    public class LoggerTests
    {
        ...
        private Contract.ILogger<LoggerTests> _logger;
        ...
        public void Init()
        {
            ...
            _logger = _serviceProvider.GetRequiredService<Contract.ILogger<LoggerTests>>();
        }
        ...
        public void When_LoggerIsUsed_Should_Log()
        {
            ...
            _logger.Log(Contract.LogLevel.Error, message);
        ...
        {
            _logger.Log(Contract.LogLevel.Debug, "");
            var log = InMemoryLogger.PopLog();
        ...
        public void When_ScopeWrapsLogs_Should_MaintainScopeOnEachLog()
        {
            ...
            {
                _logger.Log(Contract.LogLevel.Info, infoMessage);
                _logger.Log(Contract.LogLevel.Warn, warnMessage);
            }
