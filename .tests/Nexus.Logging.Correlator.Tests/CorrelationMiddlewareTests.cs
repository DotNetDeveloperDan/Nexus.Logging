    ...
    public class CorrelationMiddlewareTests
    {
        ...
        public async Task InvokeAsync_VerifyParentCorrelationId()
        {
            ...
            _mockContextFactory
                ...
                .Returns(new CorrelationContext("CorrId", "Test", "123abc", 0));
        ...
        {
            _httpContext.Request.Headers[CorrelationHeaderKeys.CorrelationId] = "Test";
            var ctx = new CorrelationContext("CorrId", "Test", "123abc", 0);
            _mockContextFactory
                .Setup(x => x.Create(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>()))
                .Returns(ctx);
        ...
        {
            _httpContext.Request.Headers[CorrelationHeaderKeys.CorrelationId] = "Test";
            var ctx = new CorrelationContext("CorrId", null, "123abc", 0);
            _mockContextFactory
                .Setup(x => x.Create(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>()))
                .Returns(ctx);
        ...
        public async Task InvokeAsync_VerifyNewCorrelationIdHeader()
        {
            ...
            _mockContextFactory
                .Setup(x => x.Create(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>()))
                .Returns(new CorrelationContext("CorrId", null, "123abc", 0));
